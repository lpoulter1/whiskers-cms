          ...
          <NavigationMenuList>
            <NavigationMenuItem className="transition ease-in-out hover:-translate-y-0.5 hover:scale-110 hover:text-orange-600">
              <NavigationMenuLink href="#home">
                 <img src="/logo_text.png" className="size-2/5 inline-block group-hover:hidden" alt="waggles &whiskers" />      
                <img src="/logo_text_orange.png" className="size-2/5 hidden group-hover:inline-block" alt="waggles &whiskers" />      
                        </NavigationMenuLink>
            </NavigationMenuItem>
          </NavigationMenuList>
        </NavigationMenu>
